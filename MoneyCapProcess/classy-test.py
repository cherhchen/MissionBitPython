...
def buttonClicked(date_entry, category_entry, item_entry, expense_entry):
    ...
    if expense_entry.strip() != '' and expense_entry.isdecimal() == True:
        ...
        var = StringVar()
        stats_label = Label(stats_frame, relief=RAISED, textvariable=var, bg='#bfe9f5', font=('Courier'))
...
about_button = Button(title_frame, text="About", highlightbackground='#C6FFBD', command=go_about)
about_button.place(relx=0.78, rely=0.4)
...
# Home Button
home_button = Button(title_frame, text="Home", highlightbackground='#C6FFBD', command=go_home)
home_button.place(relx=0.7, rely=0.4)

# More info Button
moreinfo_frame = tk.Frame(root, bg= '#239e5c')
moreinfo_button = Button(title_frame, text="More Info", highlightbackground='#C6FFBD', command=go_moreinfo)
