...
def buttonClicked(date_entry, category_entry, item_entry, expense_entry):
    ...
    if expense_entry.strip() != '' and expense_entry.isdecimal() == True:
        ...
        for i in list_of_entries:
            i.displayDate().grid(row = rownum, column=0, padx=5, pady=5)
            i.displayCategory().grid(row = rownum, column=1, padx=5, pady=5)
            i.displayName().grid(row = rownum, column=2, padx=5, pady=5)
            i.displayExpense().grid(row = rownum, column=3, padx=5, pady=5)
        ...
        var = StringVar()
        stats_label = Label(stats_frame, relief=RAISED, textvariable=var, bg='#bfe9f5', font=('Courier', 9))
        ...
        totalvar = StringVar()
        total_label = Label(stats_frame, relief=RAISED, textvariable=totalvar, bg='#bfe9f5', font=('Courier', 10 ,'bold'))
        ...
        errorMessage = tk.Label(errorFrame, text='Error: Please input the appropriate values.', font=('Courier', 9), fg='red')
...
date_label = tk.Label(lower_frame, text="Date:", font=('Courier', 10), bg='#C6FFBD')
...
category_label = tk.Label(lower_frame, text="Category:", font=('Courier', 9), bg='#C6FFBD')
...
item_label = tk.Label(lower_frame, text="Item Name:", font=('Courier', 9), bg='#C6FFBD')
...
expense_label = tk.Label(lower_frame, text="Expense($):", font=('Courier', 9), bg='#C6FFBD')
...
button.place(relx=0.91, rely=0.2, relwidth=0.105, relheight=0.7)
...
about_button = Button(root, text="About", command=go_about)
about_button.place(relx=0.65, rely=0.06)
...
# Home Button
home_button = Button(root, text="Home", command=go_home)
home_button.place(relx=0.5, rely=0.06)

# More info Button
moreinfo_frame = tk.Frame(root, bg= '#239e5c')
moreinfo_button = Button(root, text="More Info", command=go_moreinfo)
moreinfo_button.place(relx=0.8, rely=0.06)
